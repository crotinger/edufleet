...
class RolesAndPermissionsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Permission::findOrCreate('view_board_report');
        ...
        $director->syncPermissions(
            Permission::whereNot(fn ($q) => $q->where('name', 'like', '%_user')->orWhere('name', 'like', '%_role'))
                ->orWhereIn('name', ['view_audit_log', 'approve_trip_request', 'deny_trip_request', 'view_vehicle_availability', 'use_route_optimizer', 'view_board_report'])
                ->get()
        );
        ...
        $mechanic->syncPermissions(
            Permission::where(fn ($q) => $q
                ...
                ->orWhere('name', 'like', '%_post_trip_inspection'))
        ...
        $driver->syncPermissions(
            Permission::whereIn('name', [
                ...
                'create_fuel_log',
                // Drivers submit their own pre-/post-trip; they don't edit templates.
                'view_any_pre_trip_inspection', 'view_pre_trip_inspection', 'create_pre_trip_inspection',
                'view_any_post_trip_inspection', 'view_post_trip_inspection', 'create_post_trip_inspection',
            ])->get()
        );
